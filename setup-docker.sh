...
# ================================
# Script de configuración Docker
# Task Manager
# ================================

echo "🐳 Configurando Docker para Task Manager..."
...
echo -e "${BLUE}📝 Actualizando App.tsx...${NC}"
...
echo -e "${GREEN}✓ App.tsx actualizado${NC}"
...
echo ""
echo "  docker-compose build    # Construir imágenes"
